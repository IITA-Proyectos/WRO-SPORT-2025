//codigo robot escalon con deteccion de moradas, esquive con casos y barrida inicial
//codigo antes de singapur
//modificado ultima vez 16/11
#include <arduino.h>
#include <Wire.h>
...
int correccion_motor_derecho = 15;
float kpadelante = 3.0f; //antes era 10.0f
float kpdetras = 1.8f;
float kpadelante2 = 5.0f;
...
void loop() {
  ...
  correccion3 = eForCtrl3 * kpadelante2;
